...
2a. Place you Itinerum output csv files in the imput directory
2b. The scripts require 3 input files: coordinates.csv, survey_reponses.csv, and prompt_responses.csv
2c. If your output/input file names do not match these then change them, or modify the corresponding names in config.py
3a. If you have ground truth data for generating quality metric, place them in the outputs directory, titled episodes_ground_truth.csv and locations_ground_truth.csv respectively
3b. You can also change the corresponding names in config.py for ground truth data.
